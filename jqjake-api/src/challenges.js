...
const challengesWithoutId = [
...

    {
        ...
        challengeJson: {
            description: "Wipe surveillance camerage footage",
            startTime: "18:30",
            cameras: [
